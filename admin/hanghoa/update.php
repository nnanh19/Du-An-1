    ...
    <div class="card-body">
        <div class="card card-primary">
            ...
            <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <input type="hidden" class="form-control" name="ma_hh" value="<?= $ma_hh ?>">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Sản phâm có đặc biệt</label>
                        <br>
                        <input type="radio" class="" name="dac_biet" id="dac_biet" value="0" <?=$dac_biet?'checked':''?>>
                        <label for="dac_biet">Đặc biệt </label>
                        <br>
                        <input type="radio" class="" name="dac_biet" id="dac_biet_1" value="1" <?=$dac_biet?'checked':''?> >
